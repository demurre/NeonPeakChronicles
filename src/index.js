...
class MyGame extends Phaser.Scene {
    ...
    create() {
        ...
        const nameText = this.add.text(fullWidthScreen / 2, (fullHeightScreen - 150) / 2, 'name', { fontSize: '24px', fill: '#fff' }).setOrigin(0.5);
        const newGameButton = this.add.text(fullWidthScreen / 2, fullHeightScreen / 2, 'New Game', { fontSize: '24px', fill: '#fff' }).setOrigin(0.5);
    ...
    createCards() {
        const card1 = this.add.image((fullWidthScreen / 10) * 3, (fullHeightScreen / 10) * 9, 'card1').setScale(0.5).setInteractive();
        const card2 = this.add.image((fullWidthScreen / 10) * 4, (fullHeightScreen / 10) * 9, 'card2').setScale(0.5).setInteractive();
        const card3 = this.add.image((fullWidthScreen / 10) * 5, (fullHeightScreen / 10) * 9, 'card3').setScale(0.5).setInteractive();
        const card4 = this.add.image((fullWidthScreen / 10) * 6, (fullHeightScreen / 10) * 9, 'card4').setScale(0.5).setInteractive();
        const card5 = this.add.image((fullWidthScreen / 10) * 7, (fullHeightScreen / 10) * 9, 'card5').setScale(0.5).setInteractive();
